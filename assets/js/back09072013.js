var eventos_back = {
	...
	init: function()
	{
		...
		//Perguntas
		$('#btn-proxima-etapa-2-perguntas').one('click',function(e){
			e.preventDefault();
		...
		//Inicia mapeia os elementos .group do documento
			$('.group').each(function(index){
				...
				if(nome == '' || nome == 'Preencha esse campo'){
					...
					$.getJSON('../save_pergunta_perfil', {texto:nome, link_referencia:link, texto_link:texto, imagem:imagem, id_quiz:id_quiz, ordem:ordem}).done(function(e){
